...
export function getFallbackPersonalization(context = {}) {
  const emotionMap = {
    loved: {
      ...
      featuredIds: ['proposal', 'anniversary', 'surprise-reveal-box', 'things-i-never-said'],
    ...
    missed: {
      ...
      featuredIds: ['things-i-never-said', 'friendship', 'birthday', 'proposal'],
    ...
    forgiven: {
      ...
      featuredIds: ['things-i-never-said', 'friendship', 'surprise-reveal-box', 'birthday'],
  ...
  return {
    ...
    featuredIds: ['birthday', 'proposal', 'surprise-reveal-box', 'things-i-never-said'],
