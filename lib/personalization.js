...
export function getFallbackPersonalization(context = {}) {
  const emotionMap = {
    loved: {
      ...
      featuredIds: ['proposal', 'anniversary', 'birthday', 'i-miss-you'],
    ...
    missed: {
      ...
      featuredIds: ['i-miss-you', 'anniversary', 'birthday', 'proposal'],
    ...
    forgiven: {
      ...
      featuredIds: ['emotional-apology', 'anniversary', 'i-miss-you', 'birthday'],
  ...
  return {
    ...
    featuredIds: ['birthday', 'proposal', 'anniversary', 'i-miss-you'],
