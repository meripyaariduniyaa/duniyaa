export const CREATOR_TIERS = [
  ...
  { id: 'rising', name: 'Rising', minOrders: 20, commissionRate: 15, emoji: '💚' },
  { id: 'creator', name: 'Creator', minOrders: 50, commissionRate: 16, emoji: '💙' },
  { id: 'partner', name: 'Partner', minOrders: 80, commissionRate: 17, emoji: '💜' },
  { id: 'elite', name: 'Elite', minOrders: 120, commissionRate: 18, emoji: '👑' },
];
