...
export const emotionalTemplates = [
  { id: 'just-because', title: 'Just Because', icon: '✨', price: 219, description: 'A small, beautiful reminder that they matter.', emotions: ['special', 'loved'], relationships: ['partner', 'friend', 'family', 'someone-special'], photoLimit: 3 },
  ...
  { id: 'open-when', title: 'Open When…', icon: '✉️', price: 219, description: 'A collection of letters for every version of them.', emotions: ['loved', 'special'], relationships: ['partner', 'friend', 'family'], photoLimit: 6 },
  ...
  { id: 'youre-my-person', title: "You're My Person", icon: '❤️', price: 219, description: 'Celebrate the one person who feels like home.', emotions: ['loved', 'special', 'remembered'], relationships: ['partner', 'friend', 'family'], photoLimit: 5 },
];
