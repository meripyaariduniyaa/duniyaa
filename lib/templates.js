...
const legacyTemplates = [
  ...
  {
    id: 'get-well-soon',
    title: 'Warm Hug & Get Well Soon',
    icon: '🩹',
    description: 'A cozy healing journey: steaming herbal tea animation, interactive 3-dose prescription for joy cards, comforting memories, and heartfelt recovery wishes.',
    time: '≈ 3 min',
    bestFor: ['Get Well Soon', 'Cheering Up', 'Warm Hugs', 'Recovery'],
    basePrice: 499,
    price: 199,
    recommended: true,
    isNew: true,
    photoRequirement: {
      ...
      min: 0,
      max: 4,
      tip: 'Upload 1-2 funny or sweet memory photos to bring a smile to their face.'
    },
    detailsNeeded: ["Their Name", "Warm Recovery Letter", "3 Cheer-Up Prescription Doses", "1 Sweet Comfort Promise"],
    prompts: [
      "Sending you the biggest, warmest virtual hug! Rest up, take your time, and bounce back stronger 🩹❤️",
      "Here is your official prescription: 1000mg of rest, infinite snacks, and zero stress ✨",
      "You are stronger than this rough patch. Thinking of you and sending so much love and healing energy!"
    ],
    tips: "Add a funny inside joke or silly promise like bringing their favorite treat!"
  }
];
