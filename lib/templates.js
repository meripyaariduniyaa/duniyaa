export const templates = [
  ...
  },
  {
    ...
    icon: '🎂',
    description: 'An interactive birthday celebration! Pop the floating balloons, blow out the candles on the cake, and read a personal letter.',
    time: '≈ 2 min',
    ...
    photoRequirement: {
      ...
      min: 0,
      max: 0,
      tip: 'No photos needed, just your heartfelt words!'
    },
    detailsNeeded: ["Birthday Person Name", "Birth Date", "Visual Theme (Cake/Galaxy)", "Heartfelt Birthday Letter"],
    prompts: [
  ...
  },
  {
    ...
    detailsNeeded: ["Partner's Name", "Anniversary Date & Year", "Letter Text", "5 Promises"],
    prompts: [
